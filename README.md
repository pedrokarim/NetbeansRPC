...
![NetBeans](https://img.shields.io/badge/NetBeans-11.0+-orange.svg)
...
- **Language Detection**: Identifies the programming language based on file type (Java, XML, HTML, JavaScript, Python, etc.)
...
- **NetBeans IDE**: Version 11.0 or higher
...
3. Click `Add Plugins...`
4. Navigate to `target/` and select `NetbeansRPC-1.2.nbm`
...
The compiled NBM file will be available in the `target/` directory.
...
### Customizing Application ID

To use your own Discord Application ID:

1. Edit `src/main/java/fr/pedrokarim/netbeansrpc/RCPSchedule.java`
2. Locate line 32:
   ```java
   private String applicationId = "621768079386345477";
   ```
3. Replace with your Application ID:
   ```java
   private String applicationId = "YOUR_APPLICATION_ID_HERE";
   ```
